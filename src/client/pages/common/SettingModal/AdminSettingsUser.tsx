...
export function AdminSettingsUser({ form, onSave, token, userId }: Props) {
  ...
  return (
    <div className="rounded-lg border border-blue-400/20 bg-blue-400/5 p-5">
      {/* Header with status */}
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-blue-400/15 text-lg">
            ☁️
          </span>
          <div>
